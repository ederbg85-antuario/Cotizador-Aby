        ...
        {lengths.map((len) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center py-4 px-2 rounded-2xl border transition-all duration-200 ${
                sel
            ...
            >
              ...
              <span className={`text-[11px] mt-0.5 font-semibold ${sel ? 'text-white/85' : 'text-mauve-600'}`}>
                ${prices[len]}
              </span>
            </button>
          );
